...
│   ├── yeast8_ynb_final.mat         # YNB media-constrained base model
...
### Step 1: Build strain-specific models
...
Reads gene expression data and the base yeast model, then builds GIMME context-specific models for each strain. Outputs are saved to `models/strain_models_gimme/`.
...
| `models/yeast8_ynb_final.mat` | Base model constrained for YNB media | Derived from yeast-GEM |
...
| `models/strain_models_gimme/*.mat` | ~267 MB total | Generated by running Step 1. <!-- TODO: add download link --> |
